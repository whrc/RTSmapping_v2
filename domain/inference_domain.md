...
## Circumpolar Domain - With ArcticDEM

We started with the Arctic Boreal region that Anna V made to create our circumpolar region. This region is first reduced by taking the intersection with the ArcticDEM, because we may use data from the ArcticDEM. It is further reduced by taking the intersection with the permafrost zone, because permafrost is a necessary precursor for RTS.

``` r
circumpolar_dem = arctic_boreal |>
...
## Circumpolar Domain - Without ArcticDEM

We started with the Arctic Boreal region that Anna V made to create our circumpolar region. This region is reduced by taking the intersection with the permafrost zone, because permafrost is a necessary precursor for RTS.
...
## Circumpolar South Domain - With ArcticDEM

This is the portion of the ArcticDEM for which we have Planet imagery.

``` r
circumpolar_south_dem = circumpolar_dem |>
...
## Circumpolar South Domain - Without ArcticDEM

This is the portion of the Arctic boreal region for which we have Planet imagery.
...
![](inference_domain_files/figure-commonmark/unnamed-chunk-32-1.png)
...
![](inference_domain_files/figure-commonmark/unnamed-chunk-35-1.png)

![](inference_domain_files/figure-commonmark/unnamed-chunk-36-1.png)

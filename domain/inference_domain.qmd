...
# "../arctic_boreal_planet_basemaps/data/arctic_boreal_planet_basemap_grids.geojson"
# ) |>
#   st_make_valid() |>
#   rowwise() |>
...
```{r}
#| output: false
ecoregions = st_read("../../Ecoregions2017/Ecoregions2017.shp") |>
  st_transform(crs = st_crs(arctic_dem)) |>
  mutate(
    across(
      c(-geometry),
...
ggplot() +
  ...
  scale_fill_manual(
    values = c("paleturquoise2"),
    na.value = "transparent",
    na.translate = FALSE
  ) +
  geom_sf(
    data = perm_prob_sf,
    aes(color = "Permafrost Zone"),
    fill = "transparent",
    linewidth = 0.5
  ) +
  geom_sf(
...
ggplot() +
  ...
  geom_sf(
    data = circumpolar_dem,
    aes(color = "Circumpolar\n(Limited by ArcticDEM"),
    fill = "transparent",
    linewidth = 1
  ) +
...
# st_write(
#   circumpolar_dem,
#   "./domain/circumpolar_domain_ArcticDEM.geojson"
# )
```
...
#| include: false
# st_write(
#   circumpolar_south_dem,
#   "./domain/circumpolar_south_domain_ArcticDEM.geojson"
# )
```

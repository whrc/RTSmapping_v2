...
├── interannual_inference/     ← multi-year run coordinator: year × stage state, driver, alerts
├── computing/
...
| Multi-year run: stages, gates, state, alerts | `interannual_inference/README.md` |
